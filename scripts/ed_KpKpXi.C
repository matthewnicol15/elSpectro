...
void ed_KpKpXi(double ebeamE, int nEvents, int fileno)
{
  ...
  writer(new LundWriter{Form("/home/nics/work/York/elSpectro/scripts/outputs/ed_to_KpKpXi_%d_%d.dat", (int)ebeamE, fileno)});
  ...
  TFile *fout = TFile::Open(Form("/home/nics/work/York/elSpectro/scripts/outputs/ed_to_KpKpXi_%d_%d.root", (int)ebeamE, fileno), "recreate");
