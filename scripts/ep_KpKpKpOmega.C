...
void ep_KpKpKpOmega(double ebeamE, int nEvents, int fileno)
{
  ...
  writer(new LundWriter{Form("/home/nics/work/York/elSpectro/scripts/outputs/ep_to_KpKpKpOmega_%d_%d.dat", (int)ebeamE, fileno)});
  ...
  TFile *fout = TFile::Open(Form("/home/nics/work/York/elSpectro/scripts/outputs/ep_to_KpKpKpOmega_%d_%d.root", (int)ebeamE, fileno), "recreate");
